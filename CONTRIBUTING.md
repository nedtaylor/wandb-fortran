...
Thank you for considering contributing to the wandb-fortran project!
...
Please first discuss potential changes you wish to make to the project via [issues](https://github.com/nedtaylor/wandb-fortran/issues) (preferably), or [email](#contact).
...
[wandb-fortran Code of Conduct](CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior
to .

## I Have a Question

> If you want to ask a question, we assume that you have read the available [wiki](https://github.com/nedtaylor/wandb-fortran/wiki).

Before you ask a question, it is best to search for existing [Issues](https://github.com/nedtaylor/wandb-fortran/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/nedtaylor/wandb-fortran/issues/new/choose).
...
### Reporting Bugs
If you encounter any issues or have suggestions for improvement, please open an [Issue](https://github.com/nedtaylor/wandb-fortran/issues/new?template=bug_report.yaml) on the repository's issue tracker.
...
- Read the [Read*the*Docs](https://wandb-fortran.readthedocs.io/) carefully and find out if the functionality is already covered.
...
- Open a [Feature Proposal](https://github.com/nedtaylor/wandb-fortran/issues/new?template=feature_request.yaml) on the issue board (open a new issue and select the **Feature Proposal** template).
...
- Write clear and concise comments. Follow [FORD Fortran Documenter](https://forddocs.readthedocs.io/en/stable/) as implemented in existing files to keep consistency.
    - Update the wiki with new features and example guides to make wandb-fortran easier to use.
...
[src/wandb-fortran.f90](src/wf.f90).
